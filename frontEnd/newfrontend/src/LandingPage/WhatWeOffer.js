...
import solarIcon from '../assets/logo-black.png'; // Replace with actual icons
import windIcon from '../assets/logo-color.png';
import batteryIcon from '../assets/logo-white.png';
              ...
              <Grid item xs={12} sm={6} md={4} lg={3} key={index}>
                ...
                >
                  <OfferCard elevation={4}>
                    <IconBox>
                      <img src={offer.icon} alt={offer.title} style={{ width: '80px', height: '80px' }} />
                    </IconBox>
